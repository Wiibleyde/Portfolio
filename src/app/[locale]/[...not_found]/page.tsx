            ...
            <div className='flex-grow mb-auto flex flex-col bg-fixed'>
                <div className='h-screen w-full bg-opacity-60 bg-black flex flex-col justify-center items-center'>
                    <div className='flex flex-col'>
                        ...
                        <p className='text-white text-4xl font-bold flex-grow flex items-center justify-center'>{t('message')}</p>
                        <div className='flex flex-row flex-wrap justify-center space-x-4 my-16'>
                            <Link href='/' className='bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full transition duration-300'>
                                {t('home')}
                            </Link>
                        </div>
                    </div>
