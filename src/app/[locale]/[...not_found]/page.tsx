    ...
    return (
        <div className='flex flex-col min-h-screen bg-no-repeat bg-fixed overflow-x-hidden' style={{ background: 'radial-gradient(circle, rgba(255, 0, 34, 0.8) 20%, rgba(0, 0, 0, 1) 80%)', backgroundSize: 'cover', backgroundPosition: 'top' }}>
            <div className='flex-grow mb-auto flex flex-col bg-fixed'>
                <div className='h-screen w-full dark:bg-black/80 bg-white/80 flex flex-col justify-center items-center'>
                    <div className='flex flex-col animate-fade-in'>
                        <h1 className='dark:text-white text-8xl font-bold flex-grow flex items-center justify-center mb-4'>{t('title')}</h1>
                        <p className='dark:text-white text-4xl font-bold flex-grow flex items-center justify-center mb-8'>{t('message')}</p>
