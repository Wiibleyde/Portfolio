	...
	return (
		<div className="overflow-hidden w-screen h-screen rainbow-background">
			<div className="flex flex-col items-center justify-center h-full mlg-effects">
				<h1
					className="text-4xl font-bold text-white glitch"
					data-text="Lock Your Computer"
				>
					Lock Your Computer
				</h1>
				<div className="mt-4 text-white text-8xl">
					...
					{os === OsType.Mac && (
						<p>
							Press{" "}
							<span className="font-bold rainbow-text">Cmd + Ctrl + Q</span>
						</p>
					)}
					{os === OsType.Linux && (
						<p>
					...
					{os === OsType.Unknown && (
						<p className="text-2xl">
							Unknown OS{" "}
							<span className="font-bold rainbow-text">
								but you can still lock your computer
							</span>
						</p>
					)}
				</div>
