...
export default function LegalMentions() {
    ...
    useEffect(() => {
        ...
        const sections = document.querySelectorAll('.markdownApplicable h2, .markdownApplicable p, .markdownApplicable ul');
    ...
    return (
        <div ref={containerRef} className="min-h-screen relative bg-gradient-to-br from-slate-900 via-blue-900/20 to-purple-900/30 py-12">
            ...
            <div className="relative z-10 px-6 max-w-4xl mx-auto">
                ...
                {/* Content Section */}
                <div ref={contentRef} className="bg-gradient-to-br from-white/10 via-white/8 to-white/5 backdrop-blur-md rounded-3xl p-6 md:p-8 border border-white/20 shadow-2xl">
                        ...
                        <Markdown
                            options={{
                                overrides: {
                                    ...
                                    p: {
                                        component: ({ children, ...props }) => (
                                            <p {...props} className="text-gray-200 leading-relaxed mb-4 hover:text-gray-100 transition-colors duration-200">
                                                {children}
                                            </p>
                                        )
                                    },
                                    ul: {
                                        component: ({ children, ...props }) => (
                                            <ul {...props} className="list-disc list-inside text-gray-200 mb-4 space-y-1">
                                                {children}
                                            </ul>
                                        )
                                    },
                                    li: {
                                        component: ({ children, ...props }) => (
                                            <li {...props} className="text-gray-200 leading-relaxed hover:text-gray-100 duration-200 hover:translate-x-1 transition-all">
                                                {children}
                                            </li>
                                        )
                                    },
                                        ...
                                        component: ({ children, href, ...props }) => (
                                            ...
                                            >
                                                ...
                                                {href?.startsWith('http') && (
                                                    <svg className="inline w-3 h-3 ml-1 opacity-60 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="mt-8 pt-6 border-t border-white/20">
                        <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm rounded-2xl p-6 border border-blue-500/20 shadow-lg">
                            ...
                            <p className="text-gray-200 leading-relaxed">
                                Pour toute question concernant ces mentions légales ou ce site web, 
