...
export const ScrollVelocity: React.FC<ScrollVelocityProps> = ({
  ...
  function VelocityText({
    ...
    const copyWidth = useElementWidth(copyRef as RefObject<HTMLSpanElement>);
    ...
    return (
      ...
      >
        <motion.div
          className={`${scrollerClassName} flex whitespace-nowrap text-center text-4xl font-bold tracking-[-0.02em] my-5 drop-shadow md:text-[4rem] md:leading-[4rem]`}
