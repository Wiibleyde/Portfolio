		...
		>
			...
			<div ref={containerRef} className="relative z-10 px-10">
				...
				<div className="w-full max-w-7xl mx-auto grid gap-8 content-center">
					...
					<section
						ref={descriptionRef}
						className="grid lg:grid-cols-3 gap-6 w-full"
					>
						<div className="lg:col-span-2 bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/15 shadow-lg">
							<p className="text-base text-gray-200 leading-relaxed mb-3">
								...
								. Je suis passionné par le développement web fullstack et
								l&apos;exploration de diverses technologies.
							</p>
						...
						<div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm rounded-2xl p-5 border border-blue-500/20 shadow-lg flex items-center">
							<p className="text-base text-gray-300 leading-relaxed">
								J&apos;ai eu l&apos;occasion de porter plusieurs projets en tout
								genre, allant de la simple page web, à des applications plus
								complexes, en passant par le serveur de jeu.
							</p>
						</div>
					</section>
						...
						<section ref={birthRef} className="relative">
							<div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-md rounded-2xl p-6 border border-blue-500/30 shadow-xl h-full">
								...
								<p className="text-base text-gray-200 leading-relaxed mb-3">
									...
									à Paris. J&apos;ai vécu 3 années à Paris avant de déménager à{" "}
							...
							<div className="bg-gradient-to-br from-emerald-500/20 via-green-500/20 to-teal-500/20 backdrop-blur-md rounded-2xl p-6 border border-emerald-500/30 shadow-xl h-full flex flex-col">
								...
								<div className="space-y-3 flex-1 flex flex-col justify-center">
									...
									>
										...
										{/* Glow effect */}
										<div className="absolute inset-0 bg-gradient-to-r from-blue-400/50 to-purple-400/50 rounded-xl blur-md opacity-0 group-hover:opacity-70 transition-opacity duration-300 -z-10" />
										...
										{/* Corner accents */}
										<div className="absolute top-1 right-1 w-3 h-3 border-t-2 border-r-2 border-white/30 rounded-tr-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
										<div className="absolute bottom-1 left-1 w-3 h-3 border-b-2 border-l-2 border-white/30 rounded-bl-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
									</button>
									...
									>
										...
										{/* Glow effect */}
										<div className="absolute inset-0 bg-gradient-to-r from-emerald-400/50 to-teal-400/50 rounded-xl blur-md opacity-0 group-hover:opacity-70 transition-opacity duration-300 -z-10" />
										...
										{/* Download indicator */}
										<div className="absolute top-2 right-2 w-2 h-2 bg-white/50 rounded-full opacity-0 group-hover:opacity-100 group-hover:animate-ping transition-opacity duration-300" />
									</button>
								</div>

								{/* Decorative elements */}
								<div className="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-full opacity-70 blur-sm" />
								<div className="absolute -bottom-1 -left-1 w-4 h-4 bg-gradient-to-tr from-green-400 to-emerald-500 rounded-full opacity-50 blur-sm" />
							</div>
						</section>
					</div>
				</div>
					...
					>
						...
						<div className="p-4 h-[calc(90vh-80px)] bg-gradient-to-br from-gray-50 to-gray-100">
							<div className="relative w-full h-full rounded-lg overflow-hidden shadow-inner">
								...
								/>
								<div className="absolute inset-0 pointer-events-none border-2 border-blue-200/50 rounded-lg" />
							</div>
						</div>
					</div>
				</div>
