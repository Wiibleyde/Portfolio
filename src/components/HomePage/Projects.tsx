...
export function Projects() {
	...
	const [displayedFilter, setDisplayedFilter] = useState<ProjectType | "all">(
		"all",
	); // Filter actually shown
	...
	const projects: Project[] = [
		...
		},
		{
			title: "Site SABS",
			description:
				"Site vitrine du projet SABS. Découvrez [le site en ligne](https://sabs.vercel.app).",
			type: ProjectType.Personal,
		...
		},
		{
			...
			description:
				"RPlace Analyzer est un résultat d'analyse de l'événement RPlace 2017.",
			type: ProjectType.School,
		...
		},
		{
			...
			description:
				"Site web pour l'action collective du cabinet d'avocats Lex-Port.",
			type: ProjectType.Professional,
		...
		},
		{
			...
			description:
				"TwitchStreamRetrievers est une API et un WS pour notifier de streams Twitch.",
			type: ProjectType.Personal,
		...
		},
		{
			...
			description:
				"Régie vidéo du concert de Black Room Orchestra sur le serveur FailyV.",
			type: ProjectType.Personal,
		...
		},
		{
			title: "Furutsu Game",
			description:
				"Furutsu Game est une copie du jeu Suika Game fait avec Unity.",
			type: ProjectType.School,
	...
	return (
		<div
			ref={containerRef}
			className="snap-start h-screen relative bg-gradient-to-br from-slate-900 via-blue-900/20 to-purple-900/30 flex flex-col"
		>
			{/* Background pattern */}
				...
				<div ref={carouselRef} className="flex-1 flex flex-col justify-center">
					<div className="relative">
						...
						<button
							...
							className={`absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full transition-all duration-300 ${
						...
						<button
							...
							className={`absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full transition-all duration-300 ${
